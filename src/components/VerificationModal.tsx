...
const FormSchema = z
	.object({
		verificationCode: z.string().min(1, "Enter a 4-digit code").refine(value => value.length === 4, {
            ...
            <Dialog>
                <DialogTrigger asChild>
                 ...
                 <DialogContent className="max-w-[400px]">
                   ...
                   <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col space-y-4 items-center justify-items-center">
                            <FormField
                        ...
                        <FormField
							...
							render={({ field }) => (
								...
								<FormItem> 
									...
									<FormControl>
										<Input placeholder="Password" type="password" className="min-w-[200px]"{...field} />
									</FormControl>
                                 <FormMessage/>	
								</FormItem>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Input placeholder="Confirm Password" type="password"  className="min-w-[200px]" {...field}/>
									</FormControl>
                                    <FormMessage/>
								</FormItem>
							)}
