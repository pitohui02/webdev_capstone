									...
									<form className="flex flex-col space-y-4 w-fit">
										...
										<div className="flex flex-row justify-center items-center">
											<Input
												id="loginUsername"
												placeholder="Email"
												className="rounded-full min-w-[200px] ml-4"
											/>
											{/* //Verification on click 2nd state*/}
											<Dialog
												open={SecondStateOpen}
												onOpenChange={setSecondStateOpen}
											>
												<DialogTrigger
													className="bg-[#FFAF8A] rounded-lg hover:bg-[#F88D5B] duration-500 ml-5 mr-4 min-w-[180px] min-h-[36px] font-medium"
												...
												<DialogContent className="flex flex-col text-center justify-start items-center  bg-white min-w-[450px] rounded-[24px] p-8 shadow-lg shadow-black">
													...
													<div className="space-y-6">
														...
														<div className="flex flex-col items-center ">
															<Button
																variant="outline"
																className="bg-[#FFAF8A] rounded-lg hover:bg-[#F88D5B] duration-500 min-w-[400px]"
