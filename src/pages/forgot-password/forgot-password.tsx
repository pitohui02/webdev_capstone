                     ...
                     <div className= "flex flex-row">
                         <form className="flex flex-col space-y-4 w-fit mr-2">
                             <div className="flex flex-col justify-start items-start">
                                 ...
                                 <Input id="newPassword" placeholder="New Password" className="rounded-full min-w-[200px]"/>
                             </div>
                         </form>
                         ...
                         <form className="flex flex-col space-y-4 w-fit ml-2">
                             <div className="flex flex-col justify-start items-start">
                                 <Label className= "text-lg">Confirm Password</Label>
                                  ...
                                  <div className="flex flex-row justify-center items-center">
                                 <Input id="confirmPassword" placeholder="Confirm Password" className="rounded-full min-w-[200px]"/>
                             </div>
                         </form>
                     </div>
                     <Dialog>
